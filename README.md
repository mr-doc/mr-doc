...
Specifically, there is no standard on how the array of parsed source/comments should look like to support different compilers. Most of the code is a refactored version of [document.js](https://github.com/documentationjs/documentation)' and the credit goes towards them for an awesome project.
