...
class Symbol {
  ...
  static compact(tags) {
      ...
      tags.forEach(function(tag, i) {
       console.log(tag, i);
        if (!tag.type) {
          ...
          if (prevTag && prevTag.description) {
     ...
     */
  static map(symbol) {
    symbol.tags = Symbol.compact(symbol);
    var tags = {};
    [
    ...
    var
      ...
      files = tags.file,
      fileoverviews = tags.fileoverview,
      overviews = tags.overview,
      returns = tags.return,
      requires = tags.require,
      jsfiddles = tags.jsfiddle;
